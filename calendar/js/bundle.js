...
/***/ function(module, exports, __webpack_require__) {
	...
	var _three_days = __webpack_require__(159);

	var _three_days2 = _interopRequireDefault(_three_days);

	var _day = __webpack_require__(160);

	var _day2 = _interopRequireDefault(_day);

	var _hours = __webpack_require__(161);
	...
	var nestedByDay = _three_days2.default.timeslots.reduce(function (p, c) {
	...
	_reactDom2.default.render(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    'div',
	    { className: 'inline-block valign-top' },
	    _react2.default.createElement('div', { className: 'label' }),
	    _react2.default.createElement(_hours2.default, { label: 'true' })
	  ),
	  days.map(function (day) {
	    ...
	    return _react2.default.createElement(_day2.default, { key: day, id: day, events: nestedByDay[day].events });
	  })
...
/***/ function(module, exports) {
	...
	module.exports = {
		"timeslots": [
			...
			{
				"id": "5531a26278b45a15b900000c|1433359800-2",
				"available_spots": 10,
				"booked_count": 0,
				"max_guests": 10,
				"minute_length": 60,
	...
	exports.default = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    function eventStyle(event) {
	      ...
	      var start = (startDate.getHours() + startDate.getMinutes() / 60) * HOUR_HEIGHT + LABEL_HEIGHT;
	      var end = (endDate.getHours() + endDate.getMinutes() / 60) * HOUR_HEIGHT + LABEL_HEIGHT;

	      // Compare the event start and end times to other events to find overlaps.
	      var overlaps = events.filter(function (evt) {
	        return new Date(event.start) < new Date(evt.end) && new Date(event.start) >= new Date(evt.start) || new Date(event.end) <= new Date(evt.end) && new Date(event.end) > new Date(evt.start);
	      });
	      ...
	      var index = 0;
	      var indexes = overlaps.map(function (evt) {
	        return evt.index;
	      });
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: 'day-col inline-block relative' },
	      _react2.default.createElement(
	        'div',
	      ...
	      _react2.default.createElement(
	        ...
	        events.map(function (event, i) {
	          return _react2.default.createElement(
	            'div',
	            { key: event.id, className: 'event', style: eventStyle(event) },
	            event.activity_name,
	            _react2.default.createElement(
	              'div',
	              { className: 'micro' },
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      hours.map(function (hour, i) {
	        ...
	        return _react2.default.createElement(
	          'div',
	          { className: 'hour-slot border-top', key: i },
	          label
	        );
	      })
	    );
