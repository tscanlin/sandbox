...
/******/ 	__webpack_require__.p = "/build/calendar/";
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackMissingModule() { throw new Error("Cannot find module \"D:\\Code\\sandbox\\build\\calendar\\js\\bundle.js\""); }());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _day_ = __webpack_require__(160);

	var _day_2 = _interopRequireDefault(_day_);

	var _day = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./day.jsx\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var map = _day_2.default.timeslots.reduce(function (c, p) {
	  console.log(c, p);
	  // var start = new Date(p.start.split('T')[0]);
	  console.log(start);
	  // if (p.indexOf())
	...
	_reactDom2.default.render(_react2.default.createElement(
	  'div',
	  { className: 'grid' },
	  _day_2.default.timeslots.map(function (slot) {
	    ...
	    return _react2.default.createElement(_day2.default, { key: slot.id, id: slot.id });
	  })
